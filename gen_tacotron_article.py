...
if __name__ == "__main__":
    ...
    parser.add_argument('--tts_weights', type=str, default='/Users/cschaefe/best_wavernn/taco_step350K_weights.pyt',  help='[string/path] Load in different Tacotron weights')
    ...
    wr_parser.add_argument('--voc_weights', default='/Users/cschaefe/best_wavernn/raw_wavernn_1669K_taco350K_weights.pyt', type=str, help='[string/path] Load in different WaveRNN weights')
